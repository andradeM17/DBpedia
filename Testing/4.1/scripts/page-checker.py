...
def validate(category):
    ...
    with open(f"Testing/4.1/output/values/{category}-values.csv", newline="", encoding="utf-8") as values, \
    open(f"Testing/4.1/output/validations/{category}-validations.csv", "w", newline="", encoding="utf-8") as validations:
...
def main():
    ...
    if choice == "E":
        ...
        for category in CATEGORIES:
            current_category = f"random-1000/{category}"
